...
```yaml
- name: Release
  uses: spotdemo4/flake-release@v0.14.4
  with:
...
docker run -it \
  ...
  -e REGISTRY_PASSWORD=... \
  -e BUNDLE=... \
  ghcr.io/spotdemo4/flake-release:0.14.4
```

### Downloads

#### [flake-release.sh](https://github.com/spotdemo4/flake-release/releases/download/v0.14.4/flake-release.sh) - bash script
